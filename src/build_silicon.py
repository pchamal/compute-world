...
--row-hover:color-mix(in srgb,var(--ink) 11%,var(--paper));--pr:#4FBF86;--sg:#E0B060;--barbg:#2A323B;
...
{chr(10).join(rows)}
  ...
  <details class="meth" open>
    ...
    <div class="mb">
      ...
      <p><b>As-of dates.</b> SemiAnalysis public prints <b>stop at April 2026</b> and are labeled that way. August 2026 figures are neocloud and hyperscaler list pages fetched <b>{S.get("snapshot") or S["updated"]}</b>. Snapshot is the last sourced confirm day, not the last price tick. Dated history lives in <a href="/silicon-history.json">silicon-history.json</a> (append-only). Rank snapshots live in <a href="/rank-history.json">rank-history.json</a> (append-only observed ranks; never interpolated). Inference / Neoclouds / Hyperscalers join that tape once they have a published rank formula.</p>
