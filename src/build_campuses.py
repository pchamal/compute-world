...
function initGlobe(el, w, h, land){{
  ...
  var g = Globe()(el).width(w).height(h)
    ...
    .showAtmosphere(true).atmosphereColor(dark ? "#55503f" : "#bdb5a2").atmosphereAltitude(0.10)
  ...
  g.globeMaterial().color.set(dark ? "#26221a" : "#ddd4c2");
...
function applyGlobeTheme(){{
  ...
  window._globe.hexPolygonColor(function(){{ return d ? "rgba(222,216,200,0.55)" : "rgba(23,22,20,0.42)"; }});
