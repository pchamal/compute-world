...
<section class="section" aria-label="Also on compute.world">
  ...
  <div class="also">
    ...
    <a href="{SITE}/capacity.html"><b>Capacity</b><small>Company MW, sourced from EDGAR and IR</small></a>
...
def llms_txt(data, rail):
    ...
    lines = [
        ...
        f"- {SITE}/data-centers.html, {SITE}/campuses.html, {SITE}/capacity.html, {SITE}/physical-stack, {SITE}/brief.html, {SITE}/agents.html",
